 ...
 * @param personFallback    demo-режим: поиск по неизвестному полису возвращает первого пациента
 *                          (как WireMock-мок) вместо пустого результата
 */
...
public record EmuProps(
        ...
        @DefaultValue("true") boolean personFallback) {
}
